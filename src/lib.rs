...
//!
//! ```
//! pub fn process<'c, C: AsMut<[f32]> + ?Sized + 'c>(channels: impl IntoIterator<Item = &'c mut C>) {
//!     for mut channel in channels {
//!         let channel = channel.as_mut();
//!         channel[0] *= 5.0;
//!     }
...
//!
//! ... let's try to make the function signature less cryptic by introducing a cryptic trait
//! and a blanket implementation ...
//!
//! ```
...
//!
//! For your convenience, we're providing this trait here: [`ChannelMut`]
//! (as well as its non-mutable counterpart [`Channel`]).
//!
